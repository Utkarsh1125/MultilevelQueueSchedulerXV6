...
_create_proc:     file format elf32-i386
...
int main(int argc, char *argv[]){
  ...
  1c:	7f 7f                	jg     9d <main+0x9d>
	...
	if (argc < 3)
		step = 0.1;
  1e:	dd 05 80 08 00 00    	fldl   0x880
		num = 1; //default value
  ...
  30:	0f 84 a7 00 00 00    	je     dd <main+0xdd>
			printf(1, "Parent %d creating child %d\n", getpid(), pid);
  36:	e8 d7 03 00 00       	call   412 <getpid>
  3b:	56                   	push   %esi
  3c:	50                   	push   %eax
	for(i = 0; i < num; i++){
  ...
  47:	e8 94 04 00 00       	call   4e0 <printf>
			chngpr(getpid(), 3);
  4c:	e8 c1 03 00 00       	call   412 <getpid>
  51:	5e                   	pop    %esi
  52:	5a                   	pop    %edx
  53:	6a 03                	push   $0x3
  55:	50                   	push   %eax
  56:	e8 d7 03 00 00       	call   432 <chngpr>
			wait();
  5b:	e8 3a 03 00 00       	call   39a <wait>
  60:	83 c4 10             	add    $0x10,%esp
	for(i = 0; i < num; i++){
  63:	39 fb                	cmp    %edi,%ebx
  65:	7d 31                	jge    98 <main+0x98>
		pid = fork();
  67:	e8 1e 03 00 00       	call   38a <fork>
		if(pid < 0){
  6c:	85 c0                	test   %eax,%eax
		pid = fork();
  6e:	89 c6                	mov    %eax,%esi
		if(pid < 0){
  70:	79 be                	jns    30 <main+0x30>
			printf(1, "%d failed in fork!\n",getpid());
  72:	e8 9b 03 00 00       	call   412 <getpid>
  77:	83 ec 04             	sub    $0x4,%esp
	for(i = 0; i < num; i++){
  7a:	83 c3 01             	add    $0x1,%ebx
			printf(1, "%d failed in fork!\n",getpid());
  7d:	50                   	push   %eax
  7e:	68 38 08 00 00       	push   $0x838
  83:	6a 01                	push   $0x1
  85:	e8 56 04 00 00       	call   4e0 <printf>
  8a:	83 c4 10             	add    $0x10,%esp
	for(i = 0; i < num; i++){
  8d:	39 fb                	cmp    %edi,%ebx
  8f:	7c d6                	jl     67 <main+0x67>
  91:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
	...
	exit();
  98:	e8 f5 02 00 00       	call   392 <exit>
		num = atoi(argv[1]); //from command line
  9d:	83 ec 0c             	sub    $0xc,%esp
  a0:	ff 76 04             	pushl  0x4(%esi)
  a3:	e8 78 02 00 00       	call   320 <atoi>
	if (num < 0 || num > 20)
  a8:	83 c4 10             	add    $0x10,%esp
  ab:	83 f8 14             	cmp    $0x14,%eax
		num = atoi(argv[1]); //from command line
  ae:	89 c7                	mov    %eax,%edi
	if (num < 0 || num > 20)
  b0:	76 7d                	jbe    12f <main+0x12f>
	if (argc < 3)
  b2:	83 fb 02             	cmp    $0x2,%ebx
  b5:	7e 65                	jle    11c <main+0x11c>
		num = 2;
  b7:	bf 02 00 00 00       	mov    $0x2,%edi
		step = atoi(argv[2]); //from command line		
  bc:	83 ec 0c             	sub    $0xc,%esp
  bf:	ff 76 08             	pushl  0x8(%esi)
  c2:	e8 59 02 00 00       	call   320 <atoi>
  c7:	89 45 e0             	mov    %eax,-0x20(%ebp)
  ca:	83 c4 10             	add    $0x10,%esp
  cd:	db 45 e0             	fildl  -0x20(%ebp)
  d0:	dd 5d e0             	fstpl  -0x20(%ebp)
	for(i = 0; i < num; i++){
  d3:	85 ff                	test   %edi,%edi
  d5:	0f 85 51 ff ff ff    	jne    2c <main+0x2c>
  db:	eb bb                	jmp    98 <main+0x98>
			printf(1, "Child %d created\n", getpid());
  dd:	e8 30 03 00 00       	call   412 <getpid>
  e2:	52                   	push   %edx
  e3:	50                   	push   %eax
  e4:	68 69 08 00 00       	push   $0x869
  e9:	6a 01                	push   $0x1
  eb:	e8 f0 03 00 00       	call   4e0 <printf>
			chngpr(getpid(), 3);
  f0:	e8 1d 03 00 00       	call   412 <getpid>
  f5:	59                   	pop    %ecx
  f6:	5b                   	pop    %ebx
  f7:	6a 03                	push   $0x3
  f9:	50                   	push   %eax
  fa:	e8 33 03 00 00       	call   432 <chngpr>
 ...
 10b:	d9 05 88 08 00 00    	flds   0x888
 111:	df e9                	fucomip %st(1),%st
 113:	77 f3                	ja     108 <main+0x108>
 115:	dd d8                	fstp   %st(0)
 117:	e9 7c ff ff ff       	jmp    98 <main+0x98>
		step = 0.1;
 11c:	dd 05 80 08 00 00    	fldl   0x880
		num = 2;
 122:	bf 02 00 00 00       	mov    $0x2,%edi
		step = 0.1;
 127:	dd 5d e0             	fstpl  -0x20(%ebp)
 12a:	e9 fd fe ff ff       	jmp    2c <main+0x2c>
	if (argc < 3)
 12f:	83 fb 02             	cmp    $0x2,%ebx
 132:	75 88                	jne    bc <main+0xbc>
		step = 0.1;
 134:	dd 05 80 08 00 00    	fldl   0x880
 13a:	dd 5d e0             	fstpl  -0x20(%ebp)
 13d:	eb 94                	jmp    d3 <main+0xd3>
 13f:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
 ...
 694:	e9 8f fe ff ff       	jmp    528 <printf+0x48>
          s = "(null)";
 699:	bb 8c 08 00 00       	mov    $0x88c,%ebx
        while(*s != 0){
 ...
 6b1:	a1 44 0b 00 00       	mov    0xb44,%eax
{
 ...
 6ed:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6ef:	a3 44 0b 00 00       	mov    %eax,0xb44
}
 6f4:	5b                   	pop    %ebx
 6f5:	5e                   	pop    %esi
 6f6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 78f:	73 47                	jae    7d8 <malloc+0x98>
    ...
    if(p == freep)
 791:	39 05 44 0b 00 00    	cmp    %eax,0xb44
 ...
 7b6:	e8 f5 fe ff ff       	call   6b0 <free>
  return freep;
 7bb:	8b 15 44 0b 00 00    	mov    0xb44,%edx
 ...
 807:	0b 00 00 
 80a:	c7 05 48 0b 00 00 48 	movl   $0xb48,0xb48
 811:	0b 00 00 
    base.s.size = 0;
 814:	b8 48 0b 00 00       	mov    $0xb48,%eax
 819:	c7 05 4c 0b 00 00 00 	movl   $0x0,0xb4c
 820:	00 00 00 
